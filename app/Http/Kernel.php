...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        // Wise HRM role & installer middleware
        ...
        'installed' => \Modules\Core\Http\Middleware\EnsureInstalled::class,
        'not.installed' => \Modules\Core\Http\Middleware\EnsureNotInstalled::class,
        'module.enabled' => \Modules\Core\Http\Middleware\EnsureModuleEnabled::class,
    ];
}
