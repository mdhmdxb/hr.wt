...
<?php $__env->startSection('heading', 'Add Employee'); ?>

<?php $__env->startSection('content'); ?>
<form method="POST" action="<?php echo e(route('employee.store')); ?>" class="max-w-2xl space-y-4">
    <?php echo csrf_field(); ?>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Employee Code *</label>
            <input type="text" name="employee_code" value="<?php echo e(old('employee_code')); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="md:col-span-2 grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        <div>
        ...
        <div>
            ...
            <select name="site_id" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
                ...
                <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($s->id); ?>" <?php echo e(old('site_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?> (<?php echo e($s->branch->name ?? ''); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
            ...
            <select name="department_id" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($d->id); ?>" <?php echo e(old('department_id') == $d->id ? 'selected' : ''); ?>><?php echo e($d->name); ?> (<?php echo e($d->branch->name); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
            ...
            <select name="designation_id" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
                <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($des->id); ?>" <?php echo e(old('designation_id') == $des->id ? 'selected' : ''); ?>><?php echo e($des->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
            ...
            <select name="reporting_manager_id" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
                ...
                <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($m->id); ?>" <?php echo e(old('reporting_manager_id') == $m->id ? 'selected' : ''); ?>><?php echo e($m->full_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Hire Date *</label>
            <input type="date" name="hire_date" value="<?php echo e(old('hire_date')); ?>" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <select name="employment_type" required class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
                <option value="full_time" <?php echo e(old('employment_type') == 'full_time' ? 'selected' : ''); ?>>Full Time</option>
        ...
        <div>
            ...
            <input type="number" step="0.01" name="basic_salary" value="<?php echo e(old('basic_salary', 0)); ?>" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        ...
        <div>
            ...
            <input type="number" step="0.01" name="accommodation" value="<?php echo e(old('accommodation', 0)); ?>" min="0" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Transportation</label>
            <input type="number" step="0.01" name="transportation" value="<?php echo e(old('transportation', 0)); ?>" min="0" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Food allowance</label>
            <input type="number" step="0.01" name="food_allowance" value="<?php echo e(old('food_allowance', 0)); ?>" min="0" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        <div>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Other allowances</label>
            <input type="number" step="0.01" name="other_allowances" value="<?php echo e(old('other_allowances', 0)); ?>" min="0" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
        </div>
        <div>
    ...
    <div class="border-t border-slate-200 dark:border-slate-600 pt-4 mt-4">
        ...
        <label class="inline-flex items-center gap-2 cursor-pointer mb-3">
            <input type="checkbox" name="create_login" value="1" <?php echo e(old('create_login') ? 'checked' : ''); ?> class="rounded border-slate-300 dark:border-slate-600 dark:bg-slate-700" id="create_login">
        ...
        <div id="login-fields" class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3" style="display: <?php echo e(old('create_login') ? 'grid' : 'none'); ?>;">
            <div>
    ...
    <div class="border-t border-slate-200 dark:border-slate-600 pt-4 mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-wrap gap-4">
                    <?php $__currentLoopData = \Modules\Core\Models\Employee::weekdayKeys(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="weekly_off_<?php echo e($day); ?>" value="1" <?php echo e(old('weekly_off_' . $day) ? 'checked' : ''); ?> class="rounded border-slate-300 dark:border-slate-600 dark:bg-slate-700">
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex flex-wrap gap-4">
                    <?php $__currentLoopData = \Modules\Core\Models\Employee::alternateSaturdayWeekOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="alternate_sat_weeks[]" value="<?php echo e($num); ?>" <?php echo e(in_array($num, old('alternate_sat_weeks', [])) ? 'checked' : ''); ?> class="rounded border-slate-300 dark:border-slate-600 dark:bg-slate-700">
            ...
            <div>
                ...
                <input type="time" name="shift_start" value="<?php echo e(old('shift_start')); ?>" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
            </div>
            <div>
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Default shift end (optional)</label>
                <input type="time" name="shift_end" value="<?php echo e(old('shift_end')); ?>" class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-3 py-2">
            </div>
        </div>
    </div>
    <div class="flex gap-3">
        <a href="<?php echo e(route('employee.index')); ?>" class="px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-700 dark:text-slate-300">Cancel</a>
...
<?php echo $__env->make('core::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wise-HRM\Modules\Employee\Providers/../Resources/views/create.blade.php ENDPATH**/ ?>