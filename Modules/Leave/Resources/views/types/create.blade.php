    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow p-6 space-y-4">
        ...
        <div class="mt-2 space-y-2">
            <label class="flex items-start gap-2 cursor-pointer">
                <input type="checkbox" name="allow_document" value="1" {{ old('allow_document') ? 'checked' : '' }} class="mt-1 rounded border-slate-300">
            ...
            <label class="flex items-start gap-2 cursor-pointer pl-6">
                <input type="checkbox" name="require_document" value="1" {{ old('require_document') ? 'checked' : '' }} class="mt-1 rounded border-slate-300">
                <span class="text-sm text-slate-700 dark:text-slate-300">
            ...
            <div class="pl-6">
                ...
                <input type="text" name="document_label" value="{{ old('document_label') }}" placeholder="e.g. Medical certificate, Hospital letter"
